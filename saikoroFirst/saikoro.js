...
function shake() {
    ...
    sai = sai + ".png";
    console.log(sai);
    $id("saikoro").innerHTML = "<img src='saikoroImage/" + sai + "' width='100' height='100'>";
    const result = sai[0];
    if (count >= 20) {
        console.log(result);
    ...
    if (progress == 1) {
        document.getElementById('a').style.backgroundImage = "url(map/map01.png)";
    } else if
        (progress == 2) {
        document.getElementById('a').style.backgroundImage = "url(map/map02.png)";
    } else if
        (progress == 3) {
        document.getElementById('a').style.backgroundImage = "url(map/map03.png)";
    } else if
        (progress == 4) {
        document.getElementById('a').style.backgroundImage = "url(map/map04.png)";
    } else if
        (progress == 5) {
        document.getElementById('a').style.backgroundImage = "url(map/map05.png)";
    } else if
        (progress == 6) {
        document.getElementById('a').style.backgroundImage = "url(map/map06.png)";
    } else if
        (progress == 7) {
        document.getElementById('a').style.backgroundImage = "url(map/map07.png)";
    } else if
        (progress >= 8) {
        document.getElementById('a').style.backgroundImage = "url(map/map08.png)";
        document.getElementById("btn").removeAttribute("disabled");
        $('p').toggle();
        let style = '<META http-equiv="Refresh" content="3;URL=../quizEvent/quizEvent.html">';
        $('head').after(style);
    }
