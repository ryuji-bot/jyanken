...
function shake() {
    ...
    if (progress == 1) {
        document.getElementById('a').style.backgroundImage = "url(map/map09.png)";
    } else if
        (progress == 2) {
        document.getElementById('a').style.backgroundImage = "url(map/map10.png)";
    } else if
        (progress == 3) {
        document.getElementById('a').style.backgroundImage = "url(map/map11.png)";
    } else if
        (progress == 4) {
        document.getElementById('a').style.backgroundImage = "url(map/map12.png)";
    } else if
        (progress == 5) {
        document.getElementById('a').style.backgroundImage = "url(map/map13.png)";
    } else if
        (progress == 6) {
        document.getElementById('a').style.backgroundImage = "url(map/map14.png)";
    } else if
        (progress >= 7) {
        document.getElementById('a').style.backgroundImage = "url(map/map15.png)";
        document.getElementById("btn").removeAttribute("disabled");
        $('p').toggle();
        let style = '<META http-equiv="Refresh" content="3;URL=../boss/boss.html">';
        $('head').after(style);
